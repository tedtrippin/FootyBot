...
@Controller("FbWhEventParentsController")
@RequestMapping()
public class WhEventParentsController extends BaseController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/fb/eventparents")
    public ModelAndView getWhEventParents() {

        log.debug("getWhEventParents");

        ModelAndViewBuilder modelAndView = new ModelAndViewBuilder("footybot/whEventParents");
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/fb/eventparents")
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/fb/deleteeventparents")
